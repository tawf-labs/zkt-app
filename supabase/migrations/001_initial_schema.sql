...
CREATE POLICY "Users can view their admin roles"
...
CREATE POLICY "Admins can view their campaigns"
  ON public.campaigns
  FOR SELECT
  TO authenticated
  USING (
...
-- Organization admins can create campaigns for their organization
...
/*
INSERT INTO public.organizations (name, legal_name, registration_number, organization_type, email, description, city, verification_status)
VALUES
  ('Test NGO', 'Test NGO Legal', 'TEST123', 'NGO', 'test@example.com', 'A test organization for development', 'Jakarta', 'approved')
